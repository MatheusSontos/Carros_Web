    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="?page=cadastrar_proprietario">Cadastrar Proprietário</a></li>
            <li><a class="dropdown-item" href="?page=listar_proprietario">Listar Proprietário</a></li>
